...
jQuery(document).ready(function($) {
 ...
 var hours = 9 - z.getHours();
 var minutes = 30 - z.getMinutes();
 var seconds = 60 - z.getSeconds();
/*var now = "03/05/2016 00:06:00";
var n = "16/05/2016 9:30:00";


var ms = moment.utc(now,'DD/MM/YYYY HH:mm:ss').diff(moment(n,'DD/MM/YYYY HH:mm:ss'));
var q = moment.duration(ms);

var results = Math.floor(q.asHours())+moment.utc(ms).format(":mm:ss");
var time = results.split(':');
